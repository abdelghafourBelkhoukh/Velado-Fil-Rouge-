<template>
    <div class="FooterContainer mt-20">
   <div class="w-full py-10 md:px-28 sm:px-6 text-gray-800 md:flex justify-between ">
     <div class="p-5 sm:w-2/12 md:border-r">
         <div class="text-sm uppercase text-black font-bold">Menu</div>
       <ul>
         <li class="my-2">
           <a class="hover:text-black" href=""><router-link to="/">Home</router-link></a>
         </li>
        <li class="my-2">
      ...
      <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
         <a href="/#" class="w-6 mx-1">
            <svg class="fill-current cursor-pointer text-balck hover:text-white" width="100%" height="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule: evenodd; clip-rule: evenodd; stroke-linejoin: round; stroke-miterlimit: 2;">
      ...
      <div class="p-5 sm:w-3/12 flex flex-col md:block items-center">
