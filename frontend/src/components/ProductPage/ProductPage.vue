...
<div class="flex w-full h-full z-[1000] justify-center items-center fixed">
    <div  class=" bg-white  top-0 left-0 w-[90%] md:w-[95%] overflow-y-scroll">
        <!--icon to go back-->
        ...
        <div class="h-[80vh] w-full flex flex-col md:flex-row">
