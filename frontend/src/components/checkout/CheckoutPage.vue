<template>
    <div class="mt-20">
            <h1 class="flex items-center justify-center font-bold text-green-600 text-md lg:text-3xl">
                Checkout Page
            </h1>
        </div>
                            ...
                            <div class="mt-4">
                                <div class="w-full">
                                    ...
                                    <textarea
                                        ...
                                        name="Address" cols="20" rows="4" placeholder="Address" v-model="UserData.address"></textarea>
                                </div>
                            </div>
                            <div class="space-x-0 lg:flex lg:space-x-4">
                                <div class="w-full lg:w-1/2">
                ...
                <div class="flex flex-col w-full ml-0 lg:ml-12 lg:w-2/5">
                    <div class="pt-12 md:pt-0 2xl:ps-4">
                        ...
                        <div
                            ...
                            Subtotal<span class="ml-2">{{ totalPriceItems }} DH</span></div>
                        <div
                            class="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                            Shipping Tax<span class="ml-2">0 DH</span></div>
                        <div
                            class="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                            Total<span class="ml-2">{{ totalPriceItems }} DH</span></div>
                    </div>
                </div>
            </div>
        </div>
