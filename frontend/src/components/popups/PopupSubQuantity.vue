            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header ">
                        ...
                        <h5 class="modal-title  pb-8 text-xl font-medium text-center" id="modal-user">Substract Quantity</h5>
                    </div>
                    ...
                    <div class="modal-footer w-full pt-6 flex justify-end">
                        <button type="button" class="px-3 py-2 bg-black hover:bg-green-700 text-white rounded" @click="SubQuantity()">Save</button>
...
export default{
    ...
    methods:{
        ...
        SubQuantity(){
            this.newStock.quantity = this.stock.quantity - this.Quantity;
            if(!confirm("Are you sure you want to remove a quantity ?")){
                this.PopupSubQuantity();
                return;
            } 
