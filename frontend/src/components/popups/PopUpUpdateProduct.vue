<template>
    ...
    <div class=" fixed bg-black opacity-50 w-screen h-screen top-0 left-0 z-10" @click="popupUpdateProduct"></div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header ">
                        ...
                        <h5 class="modal-title  pb-8 text-xl font-medium text-center" id="modal-user">Update Product</h5>
                    </div>
                    ...
                    <div class="modal-footer w-full pt-6 flex justify-end">
                        <button type="button" class="px-3 py-2 bg-black hover:bg-green-700 text-white rounded" @click="UpdateProduct">Save</button>
                        <button type="button" class=" bg-black hover:bg-red-700 px-3 py-2 text-white rounded ml-4" data-dismiss="modal" @click="popupUpdateProduct">Close</button>
                    </div>
                </div>
            </div>
        </div>
