<template>
    <h1 class="text-center py-10 text-4xl font-semibold mt-18 md:mt-0">Best Sells</h1>
    <div class="postsContainer md:flex md:h-auto md:w-full md:justify-evenly glex-row md:flex-col lg:flex-row">
        <div v-for="post in this.$store.state.BestSells" class="post h-auto w-auto my-6">
