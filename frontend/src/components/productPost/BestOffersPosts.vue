<template>
    <h1 class="text-center py-10 text-4xl font-semibold">Best Offers</h1>
    <div class="postsContainer flex h-auto w-full md:justify-evenly flex-col lg:flex-row">
        <div v-for="post in this.$store.state.BestOffer" class="post h-auto w-auto my-6">
